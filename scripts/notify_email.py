...
if __name__ == "__main__":
    subject = os.environ.get("ALERT_SUBJECT", "Night Batch Ran")
    body = os.environ.get("ALERT_BODY", "Nightly job finished.")
    html = os.environ.get("ALERT_HTML", None)  # optional html string
